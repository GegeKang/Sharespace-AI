    ...
    <div className="flex flex-col min-h-screen bg-white text-gray-900">
      ...
      <section className="relative w-full h-[50vh]">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
          ...
          <p className="mt-4 text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 drop-shadow-lg max-w-2xl px-4">
            Brings you to the perfect roomates in seconds! <br className="hidden sm:block" />
          </p>
          <Link
            href="/discover"
            className="mt-6 sm:mt-8 inline-block rounded-full border-2 bg-blue-200 px-4 sm:px-6 py-2 sm:py-3 text-white text-base sm:text-lg font-semibold shadow-lg hover:bg-blue-600 transition"
          >
            Explore Rooms
          </Link>
        </div>
      ...
      <section className="py-12 sm:py-16 bg-blue-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mx-auto max-w-2xl text-sm sm:text-base text-gray-600 mb-8 sm:mb-12 px-4">
          ...
          <div className="grid grid-cols-1 gap-6 sm:gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col items-center p-4 sm:p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition">
              <Users className="w-10 sm:w-12 h-10 sm:h-12 text-blue-600 mb-3 sm:mb-4" />
            ...
            <div className="flex flex-col items-center p-4 sm:p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition">
              <Home className="w-10 sm:w-12 h-10 sm:h-12 text-blue-600 mb-3 sm:mb-4" />
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2 text-center">
                Verified Listings
              </h3>
              <p className="text-sm sm:text-base text-gray-600 text-center">
            ...
            <div className="flex flex-col items-center p-4 sm:p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition">
              <MapPin className="w-10 sm:w-12 h-10 sm:h-12 text-blue-600 mb-3 sm:mb-4" />
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2 text-center">
      ...
      <section className="py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-sm sm:text-base text-gray-600 text-center mx-auto max-w-2xl mb-6 sm:mb-8 px-4">
      ...
      {/* ===========================================================
         ...
         =========================================================== */}
      <section className="py-12 sm:py-16 bg-blue-50">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-8 sm:gap-12 px-4 sm:px-6 lg:flex-row lg:gap-24 lg:px-8">
          ...
          <div className="text-center lg:text-left">
            ...
            <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-600 mb-6 sm:mb-8 max-w-2xl">
              <li>
            ...
            <Link
              href="/auth/signup"
              className="inline-block px-4 sm:px-6 py-2 sm:py-3 bg-blue-200 text-white text-sm sm:text-base rounded-full font-semibold hover:bg-blue-700 transition"
            >
              Sign Up Now
            </Link>
          </div>
