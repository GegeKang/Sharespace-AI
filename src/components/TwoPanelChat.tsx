      ...
      <Box sx={{ height: '100vh', backgroundColor: '#F3F4F6' }}>
        {!activeRoomId ? (
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                  ...
                  return (
                    ...
                    >
                      <Paper
                        ...
                        sx={{
                          p: 1.5,
                          backgroundColor: isMe ? theme.palette.primary.main : '#E5E7EB',
                      ...
                      >
                        <Typography
                          variant="body2"
                          sx={{ lineHeight: 1.4, wordBreak: 'break-word', fontSize: '14px' }}
                        >
                          {m.text}
                        </Typography>
                      </Paper>
            ...
            >
              <IconButton sx={{ color: theme.palette.primary.main, p: 1 }}>
